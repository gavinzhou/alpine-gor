...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-gor:${tag}" "asia.gcr.io/orange-sys/alpine-gor:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker push asia.gcr.io/orange-sys/alpine-gor:${tag}
